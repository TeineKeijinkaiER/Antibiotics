...
const HOW_TO: { title: string; items: string[] }[] = [
  {
    title: "1. 調べたいものを選ぶ",
    items: [
      "ホームの「内服薬／注射薬／菌名／周術期」から入ります。原典（マニュアル）の章立てに合わせています。",
      "内服薬・注射薬では、次に成人／小児を選びます。以降は選んだ集団の用量だけが表示されます。",
      "菌名と周術期では成人／小児を選びません。菌の感受性率は患者によらず、周術期の1回量は体重帯で決まるためです。",
    ],
  },
  {
    title: "2. 薬剤を絞り込む",
    items: [
      "薬名の入力欄は、一般名・商品名・略語・カナのどれでも検索できます（例：クラビット／レボフロキサシン／LVFX）。",
      "内服薬は AWaRe分類（Access・Watch・Reserve・その他）でも絞り込めます。ボタンは複数選べます。",
      "注射薬は系統（β-ラクタム系・キノロン系など）で絞り込めます。",
    ],
  },
  {
    title: "3. 患者条件を入れると用量が解決する",
    items: [
  ...
  {
    title: "4. TDM対象薬の投与設計を見る",
    items: [
      "バンコマイシン・テイコプラニン・ゲンタマイシン・アミカシン・ボリコナゾールが対象です。",
      "薬剤詳細の「TDM対象」バッジ、またはホームの「その他の機能」から開けます。",
      "初回・維持投与量、採血のタイミング、目標血中濃度の順に表示します。",
